...
public class SitePanel extends JPanel {
	...
	// - - - - - Constructor - - - - -
	public SitePanel(MusicChartParser parser) {
		strChartName = "Melon";
	...
	*/
	...
	public JSONArray getArrMusic() {
		return arrMusic;
	}
	public JSONObject getMusicJSON(int index) {
	...
	/*
	Name: changeData
	Parameter: (MusicChartParser) has data inside
	Returns: -
	Description: change contents to show different chart or to refresh
	*/
	public void changeData(MusicChartParser parser) {
		...
		arrMusic = parser.getChartList();
		tableModel.setContents(arrMusic);
		buildTable();
	}
