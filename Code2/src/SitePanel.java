...
public class SitePanel extends JPanel {
	...
	private void settingTable(){
		tableChart.setModel(tableModel);
		TableColumn column;
		for(int i = 0; i < 5; i++) {
		...
		tableChart.setRowSorter(tableSorter);
	}//Function in use Constructor | Set JTable
	...
	public void dataChange(MusicChartParser parser){
		...
		arrMusic = parser.getChartList();
		tableModel.ChangeData(arrMusic);
		settingTable();
	}
